            ...
            <div id="otpModal" class="modal">
                <div class="modal-content">
                    ...
                    <p class="modal-description">
                        Please enter the One-Time Password (OTP) sent to your registered email address to verify your
                        identity.
                    </p>
                    <form id="otpForm">
                        @csrf
                        <div class="form-group">
                            ...
                            <input type="text" id="otpCode" name="verification_code" placeholder="Enter OTP"
                                class="form-input" required maxlength="6" autocomplete="off">
                        </div>
                        <button type="button" id="otpSubmit" class="btn-verify">Verify OTP</button>
                        <br>
    ...
    fetch("{{ route('verifyCode') }}", {
        ...
        .then(data => {
            if (data.success) {
                ...
                // Show the KYC modal after success
                showModal("kycModal");
            } else {
