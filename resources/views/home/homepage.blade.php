...
<div class="cta-wrap">
        ...
        <a data-analytics="CTA_demo" data-cta-name="start-trading-demo-futures" class="button white-bg hollow link-demo" href="{{route('login')}}">Login</a>
                        ...
                        <div class="bonus-box">
                            <a href="/markets/bonus" data-cta-name="bonus-page" class="link-bonus">
    ...
    <aside class="main-banner-link strip-bg"><a href="/academy/us-elections-financial-market-effects~15"><strong>As the 2024 US election nears</strong>, discover how the markets may shift and shape your trading. <strong>Read more</strong></a></aside>
</section>
    ...
    <div class="container-xxl cookie-banner-wrapper">
        <div class="cookie-banner-content">
            <figure class="image-wrapper" aria-hidden="true">
                <img loading="lazy" data-src="https://cdn-main.plus500.com/1.0.0.120605/Resources/Images/svg/cookie-popup-image.svg" src="https://cdn-main.plus500.com/1.0.0.120605/Resources/Images/svg/cookie-popup-image.svg" alt="" class="lazyload " alt="" />
            </figure>
